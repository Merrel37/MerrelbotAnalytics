...
Расширение для парсинга истории продаж buff.163.com, а также сайт для графического отображения статистики и аналитики. Аналитика производится полностью локально — сетевые запросы не выполняются.
